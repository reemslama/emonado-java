...
public class AjouterTypeController {
    ...
    public void ajouterType() {
        ...
        if (serviceTypeRendezVous.ajouter(type)) {
    ...
    public void modifierType() {
        ...
        if (serviceTypeRendezVous.modifier(selectedType)) {
    ...
    public void supprimerType() {
        ...
        if (serviceTypeRendezVous.supprimer(selectedType.getId())) {
    ...
    private String validateLibelle() {
        ...
        if (serviceTypeRendezVous.existeLibelle(libelle, excludedId)) {
    ...
    private void refreshTable() {
        tableTypes.setItems(FXCollections.observableArrayList(serviceTypeRendezVous.afficherTout()));
    }
